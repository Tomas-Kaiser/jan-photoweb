    ...
    return (
        <footer className="bg-base-200 py-4">
            <div className="bg-gradient-to-r py-10 px-6 text-center">
                <h2 className="text-3xl font-semibold mb-4">Ready to capture your best moments?</h2>
                <p className="mb-6 text-lg">
                    Whether it&apos;s portraits, events, or creative shoots — I&apos;m here to make it unforgettable.
                </p>
